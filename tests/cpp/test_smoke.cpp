...
int main() {
    ...
    // Deep ITM put should be substantial (intrinsic is 50)
    ...
    // ---- Delta sanity (put delta negative; deeper ITM => more negative) ----
    {
        ...
        assert(itm2.delta < atm.delta);  // more negative
        assert(itm2.delta > -1.0);       // should be > -1 for finite maturity
    }

    // ---- Delta stderr improves with more paths (rough check) ----
    {
        ...
        // allow slack; just ensure it improved materially
